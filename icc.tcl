...
icc_shell
import_design -format ddc -top arith64 ../netlist/arith64.ddc
...
report_qor
save_mw_cel -as arith64_routed
write -f ddc -hier -out ../netlist/arith64_postlayout.ddc
write_verilog -no_physical_only_cell -no_core_filler_cells ../netlist/arith64_postlayout.v
write_sdc ../netlist/arith64_postlayout.sdc
write_parasitics -output ../netlist/arith64_postlayout.spef
redirect -file ../reports/ICC/icc_area.rpt {report_area}
redirect -file ../reports/ICC/icc_timing.rpt {report_timing}
redirect -file ../reports/ICC/icc_clock.rpt {report_clock}
redirect -file ../reports/ICC/icc_power.rpt {report_power}
redirect -file ../reports/ICC/icc_setup.rpt {report_timing -delay max}
redirect -file ../reports/ICC/icc_hold.rpt {report_timing -delay min}
redirect -file -append ../reports/ICC/icc_clock.rpt {report_clock -skew}
